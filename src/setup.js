...
export function addAxesLabels(pageElements) {
    ...
    const xLabel = createLabel('X', `${X_LABEL_CLASS} ${DEFAULT_LABEL_CLASS}`, new THREE.Vector3(LABEL_OFFSET, 0, 0));
    const yLabel = createLabel('Y', `${Y_LABEL_CLASS} ${DEFAULT_LABEL_CLASS}`, new THREE.Vector3(0, LABEL_OFFSET, 0));
    const zLabel = createLabel('Z', `${Z_LABEL_CLASS} ${DEFAULT_LABEL_CLASS}`, new THREE.Vector3(0, 0, LABEL_OFFSET));
